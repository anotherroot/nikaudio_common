...
SYSTEMD_SERVICE_NAME="myapp"  # Optional: if you're using systemd
...
build_go() {
    ...
    # Build for Linux (assuming your server is Linux)
    GOOS=linux GOARCH=amd64 go build -o "$GO_BINARY_NAME" .
